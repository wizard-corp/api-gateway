...
var file_hello_world_proto_rawDesc = []byte{
	...
	0x6c, 0x79, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2e, 0x2f, 0x62, 0x75, 0x69, 0x6c, 0x64,
...
var file_hello_world_proto_goTypes = []any{
...
func file_hello_world_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_hello_world_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_hello_world_proto_msgTypes[1].Exporter = func(v any, i int) any {
